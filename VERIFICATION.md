...
Expect **218 checks, 0 unproved, 0 justified** — 64 functional contracts, 97 run-time checks,
57 termination. Also worth doing: `--prover=z3`, `--prover=cvc5` and `--prover=altergo`
separately, to confirm our own statement that this set is **not** 3/3 (Z3 alone 1 unproved,
CVC5 alone 4, Alt-Ergo alone 5).
