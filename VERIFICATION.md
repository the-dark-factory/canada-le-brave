...
Expect **169 checks, 0 unproved, 0 justified** — 50 functional contracts, 73 run-time checks,
46 termination. Also worth doing: `--prover=z3`, `--prover=cvc5` and `--prover=altergo`
separately, to confirm our own statement that this set is **not** 3/3 (Z3 alone 0 unproved,
CVC5 alone 1, Alt-Ergo alone 3).
